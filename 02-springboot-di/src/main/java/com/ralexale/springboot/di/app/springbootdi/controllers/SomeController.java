...
import com.ralexale.springboot.di.app.springbootdi.services.ProductService;
...
public class SomeController {
   ...
   * aumentamos el precio del producto debeido a la multiplicación que tenemos en
   * el service
   * la ideal seria que en cada escope de nuestros metodos tener una instancia del
   * ProductService
   *
   * @GetMapping
